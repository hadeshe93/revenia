...
export default function List({ i18nText, className }: ListProps) {
  return (
    <section className="section-container max-w-4xl mx-auto">
      ...
      <div className={cn("mt-6 md:mt-10 border border-primary/20 bg-slate-900 text-base-content rounded-xl p-4 grid grid-cols-1 gap-4 hover:shadow-xl hover:shadow-primary/20 transition duration-300 text-center", className)}>
