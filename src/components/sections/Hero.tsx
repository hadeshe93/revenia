  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-black text-white overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 md:px-8 max-w-4xl mx-auto">
        ...
        {/* 副标题 */}
        <p className="text-xl md:text-2xl lg:text-3xl font-light mb-8 text-gray-300 tracking-wide">
          {i18nText.subtitle}
        </p>
        
        {/* 描述文字 */}
        <p className="text-base md:text-lg lg:text-xl text-gray-400 mb-12 max-w-2xl mx-auto leading-relaxed">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          {/* 下载 Demo 按钮 */}
          <a className="group relative overflow-hidden bg-red-600 hover:bg-red-700 text-white font-bold py-4 px-8 rounded-lg transition-all duration-300 transform hover:scale-105 hover:shadow-2xl hover:shadow-red-500/25 min-w-[200px]"
          ...
          {/* 观看预告片按钮 */}
          <a className="group relative overflow-hidden bg-transparent border-2 border-base-content hover:border-base-content/60 text-white font-bold py-4 px-8 rounded-lg transition-all duration-300 transform hover:scale-105 hover:bg-white/10 min-w-[200px]"
